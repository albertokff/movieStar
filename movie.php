...
<div id="main-container" class="container-fluid">
    <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            <h3 id="reviews-title">Avalições:</h3>
            <?php if(!empty($userData) && !$userOwnsMovie && !$alreadyReviewed): ?>
            <div class="col-md-12" id="review-form-container">
                <h4>Envie sua avaliação:</h4>
                <p class="page-description">Preencha ao formulário com a nota e comentário sobre o filme</p>
            ...
            <div class="col-md-12 review">
                <div class="row">
                    <div class="col-md-1">
                        <div class="profile-image-container review-image" style="background-image: rul('<?= $BASE_URL ?>img/users/user.png')"></div>
                    </div>
